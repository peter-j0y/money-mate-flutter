...
class AppSemanticColors extends ThemeExtension<AppSemanticColors> {
  ...
  static const AppSemanticColors light = AppSemanticColors(
    ...
    textSecondary: AppColors.hexFF475569,
    textTertiary: AppColors.hexFF64748B,
  ...
  static const AppSemanticColors dark = AppSemanticColors(
    primary: AppColors.hexFF3B82F6,
    danger: AppColors.hexFFFB7185,
    success: AppColors.hexFF34D399,
    warning: AppColors.hexFFF59E0B,
    background: AppColors.hexFF020617,
    surface: AppColors.hexFF0F172A,
    surfaceMuted: AppColors.hexFF111827,
    textPrimary: AppColors.hexFFF8FAFC,
    textSecondary: AppColors.hexFFCBD5E1,
    textTertiary: AppColors.hexFF94A3B8,
    border: AppColors.hexFF334155,
    overlay: AppColors.transparent,
    inverseText: AppColors.hexFF020617,
  );
